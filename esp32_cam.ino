...
int pButton = 2; //IO2
int LED_PIN = 33; //Built-in LED on ESp-32 
...
void setup() {
  ...
  pinMode(pButton, INPUT);    // sets the digital pin 2 as Input for push button
...
// Notification LED useful for error and processing
void flashLED(int flashtime) {
  digitalWrite(LED_PIN, LOW);  // On at full power.
...
void loop() {
  // put your main code here, to run repeatedly:
    ...
    //When button pressed capture & send the image to email address
